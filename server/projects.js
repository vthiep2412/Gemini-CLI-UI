...
async function getProjects() {
  ...
  try {
    ...
    // Performance optimization: Hoist the dynamic import of sessionManager outside the loop
    // to avoid yielding to the event loop on every iteration and slowing down project listing.
