  ...
  return (
    <>
      <div className="h-full flex flex-col overflow-hidden">
          ...
          {isLoadingSessionMessages && chatMessages.length === 0 ? (
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center text-gray-500 dark:text-gray-400 px-6 sm:px-4">
                ...
                <p className="text-sm sm:text-base">Ask questions about your code, request changes, or get help with development tasks</p>
              </div>
            </div>
          ) : (
            <>
              {chatMessages.length > visibleMessageCount && (
                <div className="text-center text-gray-500 dark:text-gray-400 text-sm py-2">
                  ...
                  <button className="ml-1 text-blue-600 hover:underline" onClick={() => setVisibleMessageCount(v => v + 100)}>Load earlier</button>
                </div>
              )}
          ...
          {isLoading && (
            <div className="chat-message assistant px-3 sm:px-0">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div className="text-sm font-medium dark:text-white">Gemini</div>
              </div>
              <div className="flex space-x-1 animate-pulse ml-11">
        ...
        <div className={`p-2 sm:p-4 md:p-6 shrink-0 ${isInputFocused ? 'pb-2' : 'pb-16 sm:pb-6'}`}>
          ...
          <div className="max-w-4xl mx-auto relative">
            {attachedImages.length > 0 && (
              <div className="flex flex-wrap gap-2 mb-2 p-2 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200">
            ...
            <div {...getRootProps()} className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border dark:border-gray-600 focus-within:ring-2 focus-within:ring-blue-500 transition-all">
              ...
              <textarea 
                ...
                disabled={isLoading} 
                className="w-full pl-12 pr-12 py-3 sm:py-4 bg-transparent rounded-2xl focus:outline-none dark:text-white placeholder-gray-400 disabled:opacity-50 resize-none min-h-12 max-h-[40vh] overflow-y-auto" 
              />
              <button type="button" onClick={open} className="absolute left-2 bottom-3 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-gray-500"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg></button>
              <button type="button" disabled={!input.trim() || isLoading} onClick={handleSubmit} className="absolute right-2 bottom-3 w-10 h-10 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 rounded-full flex items-center justify-center text-white" aria-label="Send message"><svg className="w-4 h-4 transform rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" /></svg></button>
            </div>
