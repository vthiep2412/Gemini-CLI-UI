...
const TreeNodes = React.memo(function TreeNodes({ items, level = 0, expandedDirs, activeFilePath, viewMode, onClickItem, onContextMenu, renamingPath, onRenameSubmit, onRenameCancel, formatFileSize, formatRelativeTime }) {
