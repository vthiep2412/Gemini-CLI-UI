...
const SessionItem = React.memo(({
  ...
  const handleSave = React.useCallback((e) => {
    ...
    if (editInputRef.current) {
      onSessionUpdate(project.name, session.id, editInputRef.current.value);
      setEditingSession(null);
    }
  }, [onSessionUpdate, project.name, session.id, setEditingSession]);
      ...
      <div className="md:hidden">
        <div
          className={cn(
            ...
            selectedSessionId === session.id ? "bg-primary/5 border-primary/20" :
        ...
        >
          <div className="flex items-center gap-2">
            <div className={cn(
              ...
              selectedSessionId === session.id ? "bg-primary/10" : "bg-muted/50"
            )}>
